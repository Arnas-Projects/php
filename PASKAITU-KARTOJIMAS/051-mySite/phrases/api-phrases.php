...
$phrases = [
    ...
    'Dress like you\'re already famous.', // backslashintas specialią prasmę turintis simbolis tą prasmę praranda
...
$randIndex = array_rand($phrases); // paima atsitiktinį indeksą iš masyvo
$randomPhrase = $phrases[$randIndex]; // paima frazę pagal tą indeksą
