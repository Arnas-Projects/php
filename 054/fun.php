...
// $arr kintamasis turi būti array tipo
function darbasSuMasyvais(array $arr) : ?int // grąžint turi int arba NULL (?)
{
    if (is_int($arr)) {
...
$anonimFunkcija = function() {
    echo '<h2> FUN FUN </h2>';
};

$anonimFunkcija();

$colors = ['Orange', 'Blue', 'Green', 'Yeloow', 'Red'];
